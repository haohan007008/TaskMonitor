...
<script id="code">
  ...
  function init() {
    ...
    // There are only two note colors by default, blue and red, but you could add more here:
    var noteColors = ['#009CCC', '#CC293D','#CCC','#eee'];
        ...
        $(go.Panel, "Auto",
          ...
          $(go.Panel, "Table",
            ...
            $(go.TextBlock,
              {
                name: 'TEXT',
                margin: 6, font: '11px Lucida Sans Unicode, Hiragino Sans GB, WenQuanYi Micro Hei, Verdana, Aril, sans-serif', editable: true,
      ...
      $(go.Node, "Horizontal",
        {
          ...
          click: function(e, node) {
            ...
            var newdata = { group:"Problems", loc:"0 50", text: "New item " + node.containingGroup.memberParts.count };
        ...
        $(go.TextBlock, "New ", { font: '10px Lucida Sans Unicode, Hiragino Sans GB, WenQuanYi Micro Hei, Verdana, Aril, sans-serif', margin: 6,  })
      )
    );
    ...
    myDiagram.groupTemplate =
      $(go.Group, "Vertical",
        ...
        $(go.Panel, "Horizontal",
          ...
          $(go.Panel, "Horizontal",  // this is hidden when the swimlane is collapsed
            ...
            $(go.TextBlock,  // the lane label
              { font: "15px Lucida Sans Unicode, Hiragino Sans GB, WenQuanYi Micro Hei, Verdana, Aril, sans-serif", editable: true, margin: new go.Margin(2, 0, 0, 0) },
              new go.Binding("text", "text").makeTwoWay())
          )
        ...
        $(go.Panel, "Auto",  // the lane consisting of a background Shape and a Placeholder representing the subgraph
          ...
          $(go.TextBlock,  // this TextBlock is only seen when the swimlane is collapsed
            { name: "LABEL",
              font: "15px Lucida Sans Unicode, Hiragino Sans GB, WenQuanYi Micro Hei, Verdana, Aril, sans-serif", editable: true,
      ...
      myDiagram.addModelChangedListener(function(evt) {
    	    ...
    	    console.log("change is "+e.modelChange + "  || e.change= " + e.change);
...
<body onload="init()">
<div id="sample">
  <div id="myDiagramDiv" style=" width:100%; height:560px;"></div>
